...
public class CloneMain {
    public static void main(String[] args) {
        ...
        // - 깊은 복사는 직접 오버라이드하여 구현해주어야 함
        {
            Click click = new Click(3, 4);
            Click click2 = click;
            click.x = 6;
            /*
            - click 과 click2 는 동일한 주소 값을 같는 것임.(그러니까 실물은 동일한것을 바라보고 있음)
            - 때문에 heap 메모리 공간안의 객체의 데이터를 바꾸면, click과 click2 모두 변경 됨.
             */
        }
