...
public class Ex07 {
    ...
    public static void main(String[] args) {
        ...
        String test1 = str_a1 + str_a2;
        String test2 = str_a1.concat(str_a2);
        boolean result1 = test1 == test2; // 주소값 비교
        boolean result2 = test1.equals(test2); // 값 비교
        int result1_1 = System.identityHashCode(test1);
        int result2_1 = System.identityHashCode(test2);
